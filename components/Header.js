...
export default function Header(){
    ...
    return(
        ...
        <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet"/>
            ...
            <Link href={'/charity'} className={(path === '/charity'?'text-gray-400 ':'')+'flex justify-center items-center right-0'}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Link href={'/checkout'} className={(path === '/checkout'?'text-gray-400 ':'')+'flex justify-center items-center '}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <button className={`addbutton btn waves-effect waves-light flex right-0`} >Add to home screen
